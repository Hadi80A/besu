 ...
 */
package org.hyperledger.besu.consensus.nexus.network;
...
import org.hyperledger.besu.consensus.nexus.statemachine.NexusRoundFactory;
...
/** The Nexus message transmitter. */
public class NexusMessageTransmitter {

  private static final Logger LOG = LoggerFactory.getLogger(NexusMessageTransmitter.class);

  private final NexusRoundFactory.MessageFactory messageFactory;
  private final ValidatorMulticaster multicaster;
  private final Address localAddress;
  /**
   * Instantiates a new Nexus message transmitter.
   *
   * @param messageFactory the message factory
   * @param multicaster the multicaster
   */
  public NexusMessageTransmitter(final NexusRoundFactory.MessageFactory messageFactory, final ValidatorMulticaster multicaster,
