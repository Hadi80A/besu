...
/**
 * A mutable {@link NexusConfigOptions} that is used for building config for transitions in the
 * {@link ForksSchedule}.
 */
public class MutableNexusConfigOptions extends MutableBftConfigOptions implements NexusConfigOptions {
  ...
  /**
   * Instantiates a new Mutable nexus config options.
   *
   * @param posConfigOptions the nexus config options
   */
  public MutableNexusConfigOptions(final NexusConfigOptions posConfigOptions) {
