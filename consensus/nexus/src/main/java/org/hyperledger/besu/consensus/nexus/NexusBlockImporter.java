...
/** Adaptor class to allow a {@link BlockImporter} to be used as a {@link NexusBlockImporter}. */
public class NexusBlockImporter {

  private final BlockImporter blockImporter;
  private final ProtocolContext context;


  public NexusBlockImporter(
      final BlockImporter blockImporter, final ProtocolContext context) {
    this.blockImporter = blockImporter;
    this.context = context;
  }

  public boolean importBlock(final NexusBlock block) {
