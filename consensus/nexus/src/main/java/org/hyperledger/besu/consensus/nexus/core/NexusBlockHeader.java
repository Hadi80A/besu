...
public class NexusBlockHeader{
  ...
  public static NexusBlockHeader readFrom(RLPInput rlpInput, BlockHeader besuHeader) throws IOException {
    rlpInput.enterList();
    ...
    rlpInput.leaveList();
    return new NexusBlockHeader(besuHeader, round, proposer);
  }
