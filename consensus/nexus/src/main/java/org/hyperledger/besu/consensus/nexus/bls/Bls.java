package org.hyperledger.besu.consensus.nexus.bls;
...
//        logger.info("agg sig: {}", new String(aggSignatureCompressed, StandardCharsets.UTF_8));
    ...
    public static void selfTest() {
        ...
        if (!registerProofOfNexussession(a.publicKey, popA) || !registerProofOfNexussession(b.publicKey, popB)) {
