...
/** The Nexus forks schedules factory. */
public class NexusForksSchedulesFactory {
  /** Default constructor. */
  private NexusForksSchedulesFactory() {}
   ...
   */
  public static ForksSchedule<NexusConfigOptions> create(final GenesisConfigOptions genesisConfig) {
    return ForksScheduleFactory.create(
        genesisConfig.getNexusConfigOptions(),
        genesisConfig.getTransitions().getNexusForks(),
        NexusForksSchedulesFactory::createNexusConfigOptions);
  }

  private static NexusConfigOptions createNexusConfigOptions(
      final ForkSpec<NexusConfigOptions> lastSpec, final NexusFork fork) {
    final MutableNexusConfigOptions posConfigOptions =
        new MutableNexusConfigOptions(lastSpec.getValue());
