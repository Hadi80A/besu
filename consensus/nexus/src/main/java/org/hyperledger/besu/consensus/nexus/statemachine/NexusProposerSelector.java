...
import org.hyperledger.besu.consensus.nexus.core.Node;
import org.hyperledger.besu.consensus.nexus.core.NodeSet;
...
//    private SECPPublicKey selfPublicKey;
    ...
    public NexusProposerSelector(final NodeSet nodeSet,
                               final NodeKey nodeKey,
//                               final String selfId,
                               final long selfStake, NexusConfigOptions posConfigOptions) {
...
// derive y and convert to unit fraction in [0,1)
        ...
        final BigDecimal yFraction = NexusProposerSelector.toUnitFraction(yBytes);
