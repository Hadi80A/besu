...
/** Adaptor class to allow a {@link BlockValidator} to be used as a {@link NexusBlockValidator}. */
public class NexusBlockValidator {

  private final BlockValidator blockValidator;
  private final ProtocolContext protocolContext;

  /**
   * Constructs a new Nexus block validator
   *
   * @param blockValidator The Besu block validator
   * @param protocolContext The protocol context
   */
  public NexusBlockValidator(
  ...
  public ValidationResult validateBlock(final NexusBlock block) {
