...
public class NexusProtocolScheduleBuilder extends BaseBftProtocolScheduleBuilder {
    @Setter
    @Getter
    private static Blockchain blockchain;
    /** Default constructor. */
  protected NexusProtocolScheduleBuilder() {}
  /**
  ...
  public static BftProtocolSchedule create(
      ...
      final ForksSchedule<NexusConfigOptions> forksSchedule,
    ...
    return new NexusProtocolScheduleBuilder()
  ...
  protected BlockHeaderValidator.Builder createBlockHeaderRuleset(
    ...
    return NexusBlockHeaderValidationRulesetFactory.blockHeaderValidator(
        ...
        baseFeeMarket,
        NexusProtocolScheduleBuilder::getBlockchain
    );
  }
}
