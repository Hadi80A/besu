...
/** Adaptor class to allow a {@link PactusExtraDataCodec} to be used as a {@link PactusBlockCodec}. */
public class PactusBlockCodec {

  private final PactusExtraDataCodec pactusExtraDataCodec;

  /**
   * Constructs a new Pactus block codec.
   *
   * @param pactusExtraDataCodec the QBFT extra data codec
   */
  public PactusBlockCodec(final PactusExtraDataCodec pactusExtraDataCodec) {
