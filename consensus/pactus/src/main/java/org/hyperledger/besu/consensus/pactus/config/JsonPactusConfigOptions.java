...
public class JsonPactusConfigOptions extends JsonBftConfigOptions implements PactusConfigOptions {
  /** The constant DEFAULT. */
  public static final JsonPactusConfigOptions DEFAULT =
      new JsonPactusConfigOptions(JsonUtil.createEmptyObjectNode());
   ...
   */
  public JsonPactusConfigOptions(final ObjectNode bftConfigRoot) {
    super(bftConfigRoot);
  }
